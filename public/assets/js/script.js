...
(function ($) {
    ...
    /*=====================
      9. Add to wishlist product detail
      ==========================*/

    $(".product-buttons a.wishlist").on("click", function () {
        $.notify(
            {
                icon: "fa fa-check",
                title: "Success!",
    ...
    $(".qty-box .quantity-right-plus").on("click", function () {
        ...
        if (!isNaN(currentVal)) {
            ...
            $("#qty").val(currentVal + 1); // Cập nhật giá trị của input ẩn
        }
    });
    ...
    $(".qty-box .input-number").on("change", function () {
        var currentVal = parseInt($(this).val(), 10);
        if (!isNaN(currentVal)) {
            $("#qty").val(currentVal); // Cập nhật giá trị của input ẩn khi người dùng thay đổi trực tiếp
        }
    });
