...
class ProductFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $image_name =$this->faker->numberBetween(1,16).'.jpg';
        return [
            'name' => Str::title($prduct_name),
            'slug' => $slug,
            'short_description' => $this->faker->text(200),
            'description' => $this->faker->text(500),
            'sale_price' => $this->faker->numberBetween(1,22), //price sale
            'regular_price' => $this->faker->numberBetween(23,40), //price real
